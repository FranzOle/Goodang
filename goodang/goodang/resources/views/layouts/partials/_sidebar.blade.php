      ...
      <nav class="mt-2">
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item has-treeview menu-open">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                  <a href="{{ route(Auth::user()->role === 'admin' ? 'transaksi.create' : 'stafftransaksi.create', ['type' => 'in']) }}" class="nav-link">
                      <i class="fa fas fa-indent"></i>
                      <p>Transaksi Masuk</p>
                  </a>
              </li>
              <li class="nav-item">
                  <a href="{{ route(Auth::user()->role === 'admin' ? 'transaksi.create' : 'stafftransaksi.create', ['type' => 'out']) }}" class="nav-link">
              ...
              @endif
              <li class="nav-item">
                  <a href="{{ route('logtransaksi.index')}}" class="nav-link">
